(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            function initializeApp(configService) {
                return function () { return configService.loadConfig().toPromise(); };
            }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ConfigService_1;
            var ConfigService = ConfigService_1 = /** @class */ (function () {
                function ConfigService(http) {
                    this.http = http;
                }
                ConfigService.prototype.loadConfig = function () {
                    return this.http.get('/assets/json/config.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (config) { return ConfigService_1.config = config; }));
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TechConfigPipe = /** @class */ (function () {
                ...
                TechConfigPipe.prototype.transform = function (techList) {
                    var _this = this;
                    return techList.map(function (tech) { return (_this.technologyMap[tech] ? _this.technologyMap[tech] : { title: tech, class: tech }); });
                };
